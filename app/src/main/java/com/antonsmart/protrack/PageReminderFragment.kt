...
class PageReminderFragment : Fragment(R.layout.fragment_page_reminder){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listReminders.clear()
        listReminders.add(Reminder("Notificación 1","Descripción 1",fecha))
        listReminders.add(Reminder("Notificación 2","Descripción 2",fecha))
        listReminders.add(Reminder("Notificación 3","Descripción 3",fecha))
        listReminders.add(Reminder("Notificación 4","Descripción 4",fecha))
        listReminders.add(Reminder("Notificación 4","Descripción 5",fecha))
